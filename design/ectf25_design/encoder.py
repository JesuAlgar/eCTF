...
class Encoder:
    def __init__(self, secrets: bytes):
        ...
        :param secrets: Contenido del archivo de secretos generado por gen_secrets.py.
        """
    ...
    def encode(self, channel: int, frame: bytes, timestamp: int) -> bytes:
        ...
        """
        # Validar canal: si no se encuentra y no es el canal de emergencia (0), error.
        ...
        frame_mac = h.digest()
        # Estructura final:
        # channel (4 bytes) | timestamp (8 bytes) | encrypted_frame (64 bytes) | mac (32 bytes) | seq_num (8 bytes)
